...
func main() {
	...
	sayHello(english{})
	// This works because both value and pointer receiver methods are attached to *english
	sayHello(&english{})

	// This doesn't work because only value receiver methods are attached to chinese
	// sayHello(chinese{})
	sayHello(&chinese{})
}
